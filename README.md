...
| 사무실 | 주소 | 용도 | 팔레트 |
|---|---|---|---|
| 국회 | `/assembly` | 의원실 자동화 (국회회의록 수집, 기사 수집, 주말 일정 알림 등) | 국회 CI (네이비·블루·틸) |
...
- `automations/` 자동화 코드(`minutes` 국회회의록, `news` 기사 수집, `common` 상태 보고·오류 문구·Drive), `automations/runner` 실행기 설치.
