...
코드 원본은 이 저장소(`automations/minutes`)이고, GitHub Actions(`.github/workflows/minutes.yml`)가 매일 09:00(KST)에 `--daily`를 실행해 Google Drive API로 저장한다. Actions 탭의 "Run workflow"로 언제든 수동 실행할 수 있다.
