...
import { PENDING_INTEGRATIONS } from "../../company.config";
...
// "연동 대기"(자동화 준비 중)로 표시할 부서 — company.config.ts 의 PENDING_INTEGRATIONS 를 따른다
const BLOCKED_DEPTS = new Set(Object.keys(PENDING_INTEGRATIONS));
...
export class Company {
  ...
  private *dayScript(): Generator<number | (() => boolean), void, void> {
    // ① 07:00 출근
    this.phaseIndex = 1;
    this.pushLog("🚪", "07:00 자동 출근을 시작합니다. AI 직원 입장!", "yellow");
